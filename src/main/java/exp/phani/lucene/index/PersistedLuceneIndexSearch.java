...
public class PersistedLuceneIndexSearch<T extends Documentable> extends AbstractLuceneIndexSearch<T> {
    ...
    public PersistedLuceneIndexSearch(DocumentConvertor<T> convertor) throws IOException {
        super(FSDirectory.open(Paths.get("build/_index/plis")), convertor);
    }

    public static void main(String[] args) throws IOException, ParseException {
        LuceneIndexSearch<Book> luceneIndexSearch = new PersistedLuceneIndexSearch<>(new BookConvertor());
